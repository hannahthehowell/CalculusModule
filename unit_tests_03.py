...
class Assign03UnitTests(unittest.TestCase):
    ...
    def test_assign_03_prob_02_ut_04(self):
        ...
        dmndf_expr = make_plus(make_prod(make_const(-0.5),
                               ...
                               make_const(6.0))
        print(dmndf_expr)
        num_units, rev, price = maximize_revenue(dmndf_expr, constraint=lambda x: 0 <= x <= 10)
        err = 0.0001
    ...
    def test_assign_03_prob_02_ut_05(self):
        ...
        dmndf_expr = make_plus(make_prod(make_const(-1.0/200.0),
                               ...
                               make_const(12.0))
        print(dmndf_expr)
        num_units, rev, price = maximize_revenue(dmndf_expr, constraint=lambda x: 0 <= x <= 1500)
        err = 0.0001
